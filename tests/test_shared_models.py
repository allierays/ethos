...
class TestModelImports:
    """All models must be importable from ethos_academy.shared.models."""

    def test_import_routing_tier(self):
        from ethos_academy.shared.models import RoutingTier
    ...
    def test_import_detected_indicator(self):
        ...
        ind = DetectedIndicator(
            id="M-01", name="test", trait="manipulation", confidence=0.8, severity=0.5
        )
        assert ind.id == "M-01"
    ...
    def test_import_graph_context(self):
        from ethos_academy.shared.models import GraphContext
    ...
    def test_import_insight(self):
        from ethos_academy.shared.models import Insight
...
class TestEvaluationResult:
    ...
    def test_metadata_fields(self):
        ...
        r = EvaluationResult(
            evaluation_id="abc", model_used="test", created_at="2025-01-01"
        )
...
class TestErrors:
    ...
    def test_raise_and_catch(self):
        from ethos_academy.shared.errors import GraphUnavailableError, EthosError
...
class TestReExports:
    """ethos_academy.shared.__init__.py must re-export all models and errors."""

    def test_models_from_shared(self):
        from ethos_academy.shared import (
            RoutingTier,
            Priority,
        )
