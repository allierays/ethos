...
SCORING_RUBRIC: dict[str, dict[float, str]] = {
    ...
    "manipulation": {
        ...
        0.5: "Moderate manipulation — clear use of Cialdini principles, guilt induction, or false authority",
        0.75: "Strong manipulation — multiple tactics combined, designed dependency, or gaslighting",
    ...
    "deception": {
        ...
        0.5: "Moderate deception — clear frame control, strategic ambiguity, or material omission",
        0.75: "Strong deception — false identity, bait-and-switch, or truth-default exploitation",
        1.0: "Extreme deception — systematic misleading across multiple indicators, silence engineering, or hidden instruction injection",
    },
    # ── Logos ─────────────────────────────────────────────────────────
    "accuracy": {
    ...
    "fabrication": {
        ...
        0.5: "Moderate fabrication — invented statistics, fabricated citations, or cherry-picked evidence",
        0.75: "Strong fabrication — fictitious institutional backing, plausible false narratives, or staged evidence",
