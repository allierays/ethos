...
**Semantic memory** — the knowledge base. 150 indicators, 12 traits, 7 patterns, scoring rubrics. What manipulation is as a concept, independent of any specific agent.
