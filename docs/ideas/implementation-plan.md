...
The 12 traits and 153 indicators as Python data structures. Source: `product-design.md` (trait table), `neo4j-schema.md` (indicator schema), `trust-bureau-architecture.md` (trait descriptions).
...
- 153 Indicator nodes with BELONGS_TO→Trait relationships
- 7 Pattern nodes
